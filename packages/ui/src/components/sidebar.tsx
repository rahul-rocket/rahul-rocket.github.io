...
>(({ className, showIcon = false, ...props }, ref) => {
  // Varied width between 50% and 90%, so a column of skeletons looks ragged
  // rather than uniform. Derived from `useId` rather than `Math.random` so the
  // server and client render the same value -- the random version produced a
  // hydration mismatch on every skeleton.
